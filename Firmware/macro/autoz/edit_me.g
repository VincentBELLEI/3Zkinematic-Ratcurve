...
set global.clickypinname = "zstop" ; < edit leaving quotes


; THIS IS THE NAME OF THE PIN YOUR Z PIN IS CONNECTED TO
set global.zpinname = "nil" ; < edit leaving quotes
...
set global.clickyoffset = 40 ; larger values here means nozzle closer to the bed after autoz
                               ; we had 34.65 in klipper
